...
Private Const m_sLIPPackageBuilderVersion As String = "2.0.0"
...
Public Sub OpenPackageBuilder()
    ...
    oDialog.Property("url") = Application.WebFolder & "lbs.html?ap=apps/LIPPackageBuilder/views/packagebuilder&type=tab"
